    ...
    <div class="Joinbanner">
      ...
      <div class="Job">
        ...
        <div class="p1" style="top: 122px;">
          ...
          <p>1、在项目/产品经理带领下完成开发任务。<br> 2、参与项目部分需求分析和设计工作。
            ...
            3、根据设计规格书，按质、按量、按时的完成代码开发任务。<br> 4、根据项目需要，撰写及修改相应的文档。
  
  
  
            <br> 5、按照编码规范编程，并编制贯穿整个软件开发周期的文档资料。
        ...
        <div class="p1 p2">
          ...
          <p>1. Java基础扎实，两年以上的Java EE项目开发经验；<br> 2. 熟悉Spring、Mybatis、Hibernate等开源框架，两年以上实际项目开发经验。<br> 3. 熟悉MySQL等数据库应用开发；<br> 4. 熟悉memcached、redis等cache技术；<br> 5. 有丰富的主流开源框架的使用经验，并深入研究过一种以上；<br> 6. 对当前广泛使用的tomcat、nginx等HTTP Server及Application Server有较丰富的应用经验；<br>          7. 熟悉运用Javascript开发，使用过主流JS ajax框架如JQUERY等；<br> 8. 了解软件设计、开发过程，开发规范以及软件质量控制；<br> 9. 性格开朗，沟通协调能力强，具有团队合作精神；</p>
