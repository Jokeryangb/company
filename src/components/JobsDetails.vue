    ...
    <div class="Joinbanner">
      ...
      <div class="Job">
        ...
        <div class="p1" style="top: 122px;">
          ...
          <p>1、独立完成中小型项目的系统分析、设计，并主导完成详细设计和编码的任务，确保项目的进度和质量;<br> 2、参与建设通用、灵活的业务基础平台，支撑上层多场景的业务;
  
            <br> 3、执行代码检查并提供优化建议，对部分人员进行JAVA技术、开发技能等知识普及及能力培养;
  
            <br> 4、改善、维护和优化相关的产品的质量、性能、提升用户使用体验。
        ...
        <div class="p1 p2">
          ...
          <p>1、5年以上应用系统设计及开发经验；<br> 2、精通负载均衡机制、应用集群搭建、数据库集群搭建；
  
            <br> 3、精通J2EE技术平台及主流框架，具有Hibernate、Spring、Struts、mybatis等框架开发经验，深刻理解SpringMVC；
  
            <br> 4、精通Web页面开发，熟练运用HTML、JavaScript、ajax、css、JQuery;
  
            <br> 5、精通Tomcat等主流J2EE应用服务,能在Unix/Linux上布署服务;
  
            <br> 6、精通MySQL等数据库，熟悉关系数据库应用设计开发及优化;
  
            <br> 7、有基于阿里云平台的研发经验优先考虑；
  
            <br> 8、有大数据或高并发数据库开发经验优先考虑。
