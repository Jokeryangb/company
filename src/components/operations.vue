    ...
    <div class="Joinbanner">
      ...
      <div class="Job">
        ...
        <div class="p1" style="top: 122px;">
          ...
          <p>1、受理及主动电话客户，能够及时发现客户问题并给到正确和满意的回复；<br> 2、与客户建立良好的联系，熟悉及挖掘客户需求，并对客户进行系统的应用培训；
  
  
  
            <br> 3、具备处理问题、安排进展、跟进进程、沟通及疑难问题服务的意识跟能力，最大限度的提高客户满意度，遇到不能解决的问题按流程提交相关人员或主管处理，并跟踪进展直至解决；
        ...
        <div class="p1 p2">
          ...
          <p>1、具备计算机，网络布线经验，<br> 2、线下活动策划经验。
